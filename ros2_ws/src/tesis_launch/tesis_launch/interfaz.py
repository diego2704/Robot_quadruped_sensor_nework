...
# Eliminar las importaciones de VTK y agregar:
...
class STLViewer:
    def __init__(self, filename):
        ...
        self.original_points = self.mesh.points.copy()  # Store original points
    ...
    def update_stl(self, roll, pitch, yaw):
        try:
            ...
            if (abs(roll - self.previous_angles[0]) > 1 or 
                ...
                transformed_points = (R @ self.original_points.T).T
                ...
                print("No significant changes in Roll, Pitch, Yaw. Not updating rotation.")

        except Exception as e:
            print(f"Error updating STL: {e}")

    def start_update_thread(self):
        # This method can be left empty or removed if not needed
        # It was likely a placeholder from the previous implementation
        pass

    def show(self):
        self.plotter.show(interactive_update=True)

        #Muestra la ventana del visualizador
        """
        try:
            self.plotter.show()
        except Exception as e:
            print(f"Error al mostrar el visualizador: {e}")
"""
...
class SensorInterface(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.viewer = STLViewer("/home/ros_user/src/tesis_launch/tesis_launch/POCHITA_v30.stl")  # Inicializa el visualizador STL
    ...
    def create_side_buttons(self, parent):
        ...
        camara_image_path = "/home/ros_user/src/tesis_launch/tesis_launch/camara-reflex-digital.png"  # Reemplaza con la ruta de tu imagen
        ...
        # Cargar y redimensionar la imagen
        mapa_image_path = "/home/ros_user/src/tesis_launch/tesis_launch/mapas.png"  # Reemplaza con la ruta de tu imagen
        ...
        # Cargar y redimensionar la imagen
        rviz_image_path = "/home/ros_user/src/tesis_launch/tesis_launch/rviz.png"  # Reemplaza con la ruta de tu imagen
    ...
    def create_force(self, parent):
        ...
        # Cargar y redimensionar la imagen
        image_path = "/home/ros_user/src/tesis_launch/tesis_launch/perro.png"
    ...
    def open_simulation_window(self):
        ...
        try:
            # Paths
            rviz_config_path = "/home/ros_user/src/tesis_launch/tesis_launch/rviz/my_rviz_config.rviz"
